...
class OsrfSession
{
    ...
    */
    ...
    protected function writeFieldmapper()
    {
        ...
        //use namespaces for auto-loading
        $classFile = str_ireplace(__CLASS__, 'OsrfFieldmapper', __FILE__);
        $stringData = "namespace OpenSrf; \n \n";
        fwrite($fh, $stringData);
        //Write out our holding arrays as subclasses and fields
        foreach($class as $i){
            $stringData = "/**\n  * This class is auto-generated by OsrfSession::writeFieldmapper()\n */\n";
            $stringData .= "Class $i extends OsrfFieldmapper {\n";
